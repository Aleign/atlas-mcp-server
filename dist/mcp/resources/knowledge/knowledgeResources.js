...
export function registerKnowledgeResources(server) {
    ...
    server.resource("knowledge-list", ResourceURIs.KNOWLEDGE, {
        ...
        try {
            ...
            logger.error("Error listing knowledge items", error, {
                ...reqContext,
    ...
    server.resource("knowledge-by-id", ResourceTemplates.KNOWLEDGE, {
        ...
        try {
            ...
            logger.error("Error fetching knowledge by ID", error, {
                ...reqContext,
                // error is now part of the Error object passed to logger
                parameters: params,
            });
    ...
    server.resource("knowledge-by-project", ResourceTemplates.KNOWLEDGE_BY_PROJECT, {
        ...
        try {
            ...
            logger.error("Error listing knowledge for project", error, {
                ...reqContext,
                // error is now part of the Error object passed to logger
                parameters: params,
            });
