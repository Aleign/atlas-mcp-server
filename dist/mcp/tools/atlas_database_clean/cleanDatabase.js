...
import { AtlasDatabaseCleanSchema } from "./types.js";
 ...
 */
export const atlasDatabaseClean = async (input, context) => {
    ...
    try {
        ...
        const validatedInput = AtlasDatabaseCleanSchema.parse(input);
        ...
        throw new McpError(BaseErrorCode.INTERNAL_ERROR, `Error resetting database: ${error instanceof Error ? error.message : "Unknown error"}`);
    }
};
