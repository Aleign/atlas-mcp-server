 ...
 */
export function registerAtlasKnowledgeListTool(server) {
    registerTool(server, "atlas_knowledge_list", "Lists knowledge items according to specified filters with tag-based categorization, domain filtering, and full-text search capabilities", {
        projectId: z
            .string()
