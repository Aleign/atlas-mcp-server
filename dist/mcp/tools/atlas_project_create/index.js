import { z } from "zod";
import { createProjectStatusEnum } from "../../../types/mcp.js";
...
export const registerAtlasProjectCreateTool = (server) => {
    registerTool(server, "atlas_project_create", "Creates and initializes new projects within Atlas task management with comprehensive metadata, dependencies, and integration with the knowledge management system", AtlasProjectCreateSchemaShape, atlasCreateProject, createToolMetadata({
        examples: [
            createToolExample({
                mode: "single",
