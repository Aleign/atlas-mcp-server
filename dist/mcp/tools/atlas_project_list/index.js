import { z } from "zod";
import { ResponseFormat, createProjectStatusEnum, // Import the enum helper
createResponseFormatEnum, createToolResponse, } from "../../../types/mcp.js";
 ...
 */
export function registerAtlasProjectListTool(server) {
    registerTool(server, "atlas_project_list", "Retrieves and filters project entities based on specified criteria with pagination support and relationship expansion capabilities", {
        mode: z
            .enum(["all", "details"])
            .optional()
            .default("all")
