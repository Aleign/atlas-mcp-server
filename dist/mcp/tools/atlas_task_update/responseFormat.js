...
class SingleTaskUpdateFormatter {
    format(data) {
        ...
        if (taskData.id)
            details += `ID: ${taskData.id}\n`;
        if (taskData.projectId)
            details += `Project ID: ${taskData.projectId}\n`;
        if (taskData.title)
        ...
        if (taskData.assignedTo)
            details += `Assigned To: ${taskData.assignedTo}\n`;
        // Format URLs array
        if (taskData.urls) {
        ...
        if (taskData.taskType)
            details += `Task Type: ${taskData.taskType}\n`;
        // Format dates
 ...
 */
export function formatTaskUpdateResponse(data, isError = false) {
