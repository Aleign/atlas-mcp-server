import { z } from "zod";
import { ResponseFormat, createPriorityLevelEnum, createResponseFormatEnum, createTaskStatusEnum, createTaskTypeEnum, } from "../../../types/mcp.js";
...
const BulkTaskUpdateSchema = z
    ...
    tasks: z
        ...
        .min(1)
        .max(100)
        .describe("Collection of task updates to be applied in a single transaction"),
    responseFormat: createResponseFormatEnum()
        .optional()
        .default(ResponseFormat.FORMATTED)
        .describe("Desired response format: 'formatted' (default string) or 'json' (raw object)"),
...
export const AtlasTaskUpdateSchemaShape = {
    mode: z
        .enum(["single", "bulk"])
        .describe("Operation mode - 'single' for one task, 'bulk' for multiple tasks"),
    id: z
        .string()
        .optional()
    ...
    updates: z
        ...
        .optional()
        .describe("Object containing fields to modify (only specified fields will be updated) (required for mode='single')"),
    tasks: z
        .array(z.object({
        id: z.string(),
        updates: z.object({
        ...
        .optional()
        .describe("Array of task updates, each containing an ID and updates object (required for mode='bulk')"),
    responseFormat: createResponseFormatEnum()
        .optional()
        .describe("Desired response format: 'formatted' (default string) or 'json' (raw object)"),
};
