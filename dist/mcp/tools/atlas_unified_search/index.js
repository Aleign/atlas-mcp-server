...
export const registerAtlasUnifiedSearchTool = (server) => {
    registerTool(server, "atlas_unified_search", "Performs a unified search across specified entity types (node labels) with relevance scoring and flexible filtering options", // Updated description
    {
        property: z
            .string()
            .optional()
            .describe("Specific property to search within (e.g., name, description, text)"),
        value: z
            .string()
            .describe("Search term or phrase to find across the knowledge base (required)"),
        entityTypes: z
            .array(z.string())
            .optional()
            .describe("Array of entity types (node labels) to include in search (Default: project, task, knowledge if omitted)"),
        caseInsensitive: z
            .boolean()
            .optional()
            .default(true)
            .describe("Boolean flag to ignore case sensitivity when searching for better recall (Default: true)"),
        fuzzy: z
            .boolean()
            .optional()
            .default(false)
            .describe("Boolean flag to enable approximate matching for typos, spelling variations, and similar terms (Default: false)"),
        taskType: z.string().optional().describe("Optional filter by project/task classification type for more targeted results (applies only if searching Project or Task types)"),
        assignedToUserId: z
            .string()
            .optional()
            .describe("Optional: Filter tasks by the ID of the assigned user. Only applicable when 'property' is specified (regex search) and 'entityTypes' includes 'task'."),
        page: z
            .number()
            .optional()
        ...
        returnSchema: z.object({
            results: z.array(z.object({
                ...
                entityType: z
                    .string()
                    .optional()
                    .describe("Specific classification of the entity (e.g., taskType, domain)"), // Made optional as it might not apply to all types
                title: z
                    .string()
                    .describe("Entity title or name (might be generated for some types)"),
                description: z
                    .string()
                    .optional()
                    .describe("Entity description text (might be primary text for some types)"), // Made optional
                matchedProperty: z
                    .string()
