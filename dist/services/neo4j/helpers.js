 ...
 */
export const escapeRelationshipType = (type) => {
 ...
 */
export function buildUpdateQuery(nodeLabel, // Keep nodeLabel for potential future use or context
identifier, updates) {
    const params = {};
    const setClauses = [];
 ...
 */
export function buildListQuery(label, returnProperties, filters, pagination, nodeAlias = "n", additionalMatchClauses = "") {
    const params = {};
    let conditions = [];
    // --- Base MATCH Clause ---
