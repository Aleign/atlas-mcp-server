 ...
 */
export async function _fullTextSearch(searchValue, options = {}) {
    ...
    try {
        ...
        const typesToUse = rawEntityTypes &&
        ...
        `;
                ...
                logger.error("Error during project full-text search query", err, {
                    ...reqContext_fullText,
                    targetLabel: "project",
                    detail: err.message,
                });
        ...
        `;
                ...
                logger.error("Error during task full-text search query", err, {
                    ...reqContext_fullText,
                    targetLabel: "task",
                    detail: err.message,
                });
        ...
        `;
                ...
                logger.error("Error during knowledge full-text search query", err, {
                    ...reqContext_fullText,
